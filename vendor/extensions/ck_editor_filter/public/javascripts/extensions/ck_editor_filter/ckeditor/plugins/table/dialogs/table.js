...
(function(){
    ...
    function d(e, f){
        ...
        return {
            ...
            onShow: function(){
                var o = this;
                var h = e.getSelection(), i = h.getRanges(), j = null, k = o.getContentElement('info', 'txtRows'), l = o.getContentElement('info', 'txtCols'), m = o.getContentElement('info', 'txtWidth');
            ...
            onOk: function(){
                var C = this;
                if (C._.selectedElement) 
                    var h = e.getSelection(), i = e.getSelection().createBookmarks();
                var j = C._.selectedElement || g('table'), k = C, l = {};
                C.commitContent(l, j);
                if (l.info) {
                    var m = l.info;
                    if (!C._.selectedElement) {
                        var n = j.append(g('tbody')), o = parseInt(m.txtRows, 10) || 0, p = parseInt(m.txtCols, 10) || 0;
                        for (var q = 0; q < o; q++) {
                            var r = n.append(g('tr'));
                            for (var s = 0; s < p; s++) {
                                var t = r.append(g('td'));
                    ...
                    if (!C.hasColumnHeaders && (u == 'col' || u == 'both')) 
                    ...
                    var A = [];
                    if (m.txtHeight) 
                        j.setStyle('height', CKEDITOR.tools.cssLength(m.txtHeight));
                    else 
                        j.removeStyle('height');
                    if (m.txtWidth) {
                        var B = m.cmbWidthType || 'pixels';
                        j.setStyle('width', m.txtWidth + (B == 'pixels' ? 'px' : '%'));
                    }
                    else 
                        j.removeStyle('width');
                ...
                elements: [{
                    ...
                    children: [{
                        ...
                        children: [{
                            ...
                            items: [[e.lang.common.notSet, ''], [e.lang.table.alignLeft, 'left'], [e.lang.table.alignCenter, 'center'], [e.lang.table.alignRight, 'right']],
                            setup: function(h){
                        ...
                        children: [{
                            ...
                            children: [{
                                ...
                                onLoad: function(){
                                    var h = this.getDialog().getContentElement('info', 'cmbWidthType'), i = h.getElement(), j = this.getInputElement(), k = j.getAttribute('aria-labelledby');
                                    j.setAttribute('aria-labelledby', [k, i.$.id].join(' '));
                                },
                                setup: function(h){
                            ...
                            children: [{
                                ...
                                onLoad: function(){
                                    var h = this.getDialog().getContentElement('info', 'htmlHeightType'), i = h.getElement(), j = this.getInputElement(), k = j.getAttribute('aria-labelledby');
                                    j.setAttribute('aria-labelledby', [k, i.$.id].join(' '));
                                },
                                setup: function(h){
                            ...
                            id: 'txtClass',
                            style: 'width:12em',
                            label: 'Třída (šablona vzhledu)',
                            setup: function(h){
                                this.setValue(h.getAttribute('class') || '');
                            },
                            commit: function(h, i){
                                if (this.getValue()) 
                                    i.setAttribute('class', this.getValue());
                                else 
                    ...
                    children: [{
                        ...
                        commit: function(h, i){
                            var j = this.getValue(), k = i.getElementsByTag('caption');
                            if (j) {
                                if (k.count() > 0) {
                                    k = k.getItem(0);
                                    k.setHtml('');
                        ...
                        setup: function(h){
                            this.setValue(h.getAttribute('summary') || '');
                        },
                        commit: function(h, i){
                            if (this.getValue()) 
                                i.setAttribute('summary', this.getValue());
                        }
                    }]
                }]
            }]
