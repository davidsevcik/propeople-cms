  ...
  def load_default_regions
    ...
    admin.sites = returning OpenStruct.new do |sites|
      sites.index = Radiant::AdminUI::RegionSet.new do |index|
        index.header.concat %w{name_th base_th language_th modify_th order_th}
        index.row.concat %w{name_td base_td language_td modify_td order_td}
      end
      sites.edit = Radiant::AdminUI::RegionSet.new do |edit|
        edit.main.concat %w{edit_header edit_form}
        edit.form.concat %w{edit_name edit_match edit_base edit_language edit_homepage}
